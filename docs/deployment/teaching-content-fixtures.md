...
- `problems/ai/programming/`：AI 编程题的描述、模板、输入与标准输出文件；题目目录可以使用具体题名。
...
成功时 Django 应报告导入 102 个对象。AI 测试点从项目根目录的 `problems/ai/programming/` 读取，并兼容旧的 `problems/ai/problem*/` 目录。
